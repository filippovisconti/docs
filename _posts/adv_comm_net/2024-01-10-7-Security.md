...
Now Network properties are successfully verified. But, are users reaching the correct website? Or... do they even reach the website? ![shutup](/assets/img/Pasted%20image%2020240116170312.png) It’s likely
due to a network attack that is causing failures! Network attacks are very common nowadays and they're affecting many critical Internet services.
...
Let’s assume no threats within AS30 ![shutup](/assets/img/Pasted%20image%2020240116175756.png)
...
![shutup](/assets/img/Pasted%20image%2020240116175904.png)
...
Exposing information to unauthorised people. Can AS20 learn the business relationship between A10 and AS30? ![shutup](/assets/img/Pasted%20image%2020240116180025.png) YES! But Relationship inference may be
imperfect.
...
Can AS20 launch denial-of-service attacks against AS30’s router? ![shutup](/assets/img/Pasted%20image%2020240116180049.png)
...
DDoS attacks always become more threatening In 2023, Google mitigated 398 Mrps. ![shutup](/assets/img/Pasted%20image%2020240116184629.png) ![shutup](/assets/img/Pasted%20image%2020240116184647.png)

## Pulse-wave DDoS attacks

A naïve DDoS defense: ![shutup](/assets/img/Pasted%20image%2020240116185631.png)
...
1. Represent packets by points in the header space![shutup](/assets/img/Pasted%20image%2020240116185755.png)
2. Represent clusters using registers/bloom filters![shutup](/assets/img/Pasted%20image%2020240116185820.png)
3. Use Manhattan distance for easy implementation![shutup](/assets/img/Pasted%20image%2020240116185831.png)

#### Controlling clustered packets

Deprioritising malicious clusters via scheduling.

![shutup](/assets/img/Pasted%20image%2020240116185902.png)
...
ACC-Turbo mitigates pulse-wave DDoS attacks effectively: ![shutup](/assets/img/Pasted%20image%2020240116185941.png)
