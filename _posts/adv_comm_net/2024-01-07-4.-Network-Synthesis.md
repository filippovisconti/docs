...
The configuration satisfies the specification if $C_{cust} > C_{prov}$ ![](/assets/img/Pasted%20image%2020240115154617.png) Let’s pick parameters $C_{cust}, C_{prov}$ “randomly”. ![](/assets/img/Pasted%20image%2020240115154641.png) The verifier finds a counter example x1: ![](/assets/img/Pasted%20image%2020240115154656.png) x1 “invalidates” the parameter space where $C_{cust} < C_{prov}$ ![](/assets/img/Pasted%20image%2020240115154720.png) The
synthesizer then picks parameters that satisfy x1 ![](/assets/img/Pasted%20image%2020240115154755.png) The synthesizer then finds a counter example x2 ![](/assets/img/Pasted%20image%2020240115154815.png) x2 “invalidates” the parameter space where $C_{cust} = C_{prov}$ The synthesizer picks parameters that satisfy x1 and x2.
