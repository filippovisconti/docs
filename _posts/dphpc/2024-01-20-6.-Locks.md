...
![](/assets/img/ScreenShot%202024-01-06%20at%2022.33.56.png)
...
- Load-linked/Store-Conditional LL/SC (or load-acquire (LDA) store-release (STL) on ARM)
  ...
  - commits only if no other updates committed
    - →mini-TM
- Intel TSX (transactional synchronisation)
...
- ![](/assets/img/ScreenShot%202024-01-06%20at%2022.52.59.png) How can we make it even less likely? ![](/assets/img/ScreenShot%202024-01-06%20at%2022.53.10.png)
...
- Synchronising M objects requires Θ(NM) storage

![](/assets/img/ScreenShot%202024-01-06%20at%2022.55.04.png)
...
![](/assets/img/ScreenShot%202024-01-06%20at%2022.55.48.png)
...
- More atomics! ![](/assets/img/ScreenShot%202024-01-06%20at%2022.56.44.png) ![](/assets/img/ScreenShot%202024-01-06%20at%2022.56.52.png)
...
- `read_(un)lock()`
- `write_(un)lock()` ![](/assets/img/ScreenShot%202024-01-07%20at%2010.45.39.png) Seems efficient!?
- Is it? What’s wrong?
...
> If randomised algorithms are used, then $e/(e-1)$-competitiveness $(~1.58)$ can be achieved
