...
> Question: is that useful given that locks provide mutual exclusivity? Mutual exclusivity means serialisation increasing Amdahl’s serial fraction limiting scalability, right?

![](/assets/img/ScreenShot%202024-01-07%20at%2010.52.13.png)
...
![](/assets/img/ScreenShot%202024-01-07%20at%2012.08.19.png)

### Ingredient 2 - Reader-Writer Locks

![](/assets/img/ScreenShot%202024-01-07%20at%2012.09.02.png)

### Remote Memory Access Programming

![](/assets/img/ScreenShot%202024-01-07%20at%2012.10.05.png)RDMA support implemented in hardware in NICs in the majority of HPC networks

### RMA-RW - Required Operations

![](/assets/img/ScreenShot%202024-01-07%20at%2012.10.42.png)

### Recitation recap: MPI RMA

![](/assets/img/ScreenShot%202024-01-07%20at%2012.11.01.png)

![](/assets/img/ScreenShot%202024-01-07%20at%2012.11.20.png)

How to ensure tunable performance? Each DQ: fairness vs throughput of writers DC: a parameter for the latency of readers vs writers A tradeoff parameter for every structure DT: a parameter for the throughput of readers vs writers
...
$$𝑇_{𝐿,𝑖}$$ >Larger $𝑇_{𝐿,𝑖}$: more throughput at level i. >Smaller $𝑇_{𝐿,𝑖}$: more fairness at level i.

![](/assets/img/ScreenShot%202024-01-07%20at%2012.14.39.png)
...
![](/assets/img/ScreenShot%202024-01-07%20at%2012.15.36.png)

### DISTRIBUTED COUNTER (DC) Latency of readers vs writers

> DC: every kth compute node hosts a partial counter, all of which constitute the DC. $$𝑘 = 𝑇_{𝐷𝐶}$$

![](/assets/img/ScreenShot%202024-01-07%20at%2012.16.36.png)

![](/assets/img/ScreenShot%202024-01-07%20at%2012.16.48.png) ![](/assets/img/ScreenShot%202024-01-07%20at%2012.21.19.png)
...
- Guarantees that infinitely often some method call finishes in a finite number of steps A wait-free method
...
- Recurring theme: helping (faster threads help slower threads, e.g., wait-free queues ) Synchronization instructions are not equally powerful!
...
![](/assets/img/ScreenShot%202024-01-07%20at%2012.52.34.png)
...
- If we have int_decide(int) as primitive, we can implement bin_decide(bit) and vice-versa ![](/assets/img/ScreenShot%202024-01-07%20at%2012.54.46.png)

### Anatomy of a State (in Two-Thread Consensus)

![](/assets/img/ScreenShot%202024-01-07%20at%2012.55.29.png) ![](/assets/img/ScreenShot%202024-01-07%20at%2012.55.42.png)

### State Diagrams of Two-thread Consensus Protocols

![](/assets/img/ScreenShot%202024-01-07%20at%2012.55.03.png)
...
![](/assets/img/ScreenShot%202024-01-07%20at%2013.20.48.png)

> [!Bivalent State] A (bivalent) state is called critical if both child states are univalent!

![](/assets/img/ScreenShot%202024-01-07%20at%2013.21.41.png)

![](/assets/img/ScreenShot%202024-01-07%20at%2013.23.02.png)
...
![](/assets/img/ScreenShot%202024-01-07%20at%2013.24.09.png)

### Impossibility Proof Setup – Possible actions of a thread

![](/assets/img/ScreenShot%202024-01-07%20at%2013.24.30.png)

![](/assets/img/ScreenShot%202024-01-07%20at%2013.24.43.png)

### Many Cases to check

![](/assets/img/ScreenShot%202024-01-07%20at%2014.11.48.png)

### Impossibility Proof Case I: A reads

![](/assets/img/ScreenShot%202024-01-07%20at%2014.12.30.png) What did we just prove? ![](/assets/img/ScreenShot%202024-01-07%20at%2014.19.30.png)

### Impossibility Proof Case I’: B reads

![](/assets/img/ScreenShot%202024-01-07%20at%2014.19.46.png) What did we just prove? ![](/assets/img/ScreenShot%202024-01-07%20at%2014.20.00.png)

### Impossibility Proof Case II: A and B write to different registers

![](/assets/img/ScreenShot%202024-01-07%20at%2014.20.26.png)

What did we just prove? ![](/assets/img/ScreenShot%202024-01-07%20at%2014.20.43.png)

### Impossibility Proof Case III: A and B write to the same register

![](/assets/img/ScreenShot%202024-01-07%20at%2014.21.06.png)

### Conclusion

![](/assets/img/ScreenShot%202024-01-07%20at%2014.21.14.png)
